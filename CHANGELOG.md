...
### Features
- **daemon**: Allow colon (`:`) character in process names.

### Bug Fixes
- **debian**: Migrate `lynx` user home directory to `/var/lib/lynx-pm` in postinst script if it was pointing to the old path.
