...
// ConfigureProcessIsolation attaches the SysProcAttr appropriate for
// the requested RunAs mode. Setpgid is enabled unconditionally so Stop
// can kill(-pid) the whole group; dynamic / sandbox are handled at a
// higher layer.
